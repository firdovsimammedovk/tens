...
(function() {
  ...
  var defaultVersions = [
    { version: 'v2.10.0', url: '/tens/tt-metal/ttnn/get_started.html', label: 'v2.10.0 (stable)' },
    { version: 'v0.59.0', url: '/tens/tt-metal/v0.59.0/ttnn/get_started.html', label: 'v0.59.0' },
    { version: 'v0.58.0', url: '/tens/tt-metal/v0.58.0/ttnn/get_started.html', label: 'v0.58.0' },
    { version: 'v0.57.0', url: '/tens/tt-metal/v0.57.0/ttnn/get_started.html', label: 'v0.57.0' },
    { version: 'v0.56.0', url: '/tens/tt-metal/v0.56.0/ttnn/get_started.html', label: 'v0.56.0' },
    { version: 'v0.55.0', url: '/tens/tt-metal/v0.55.0/ttnn/get_started.html', label: 'v0.55.0' },
    { version: 'v0.54.0', url: '/tens/tt-metal/v0.54.0/ttnn/get_started.html', label: 'v0.54.0' }
  ];

  function getCurrentVersion() {
    var path = window.location.pathname;
    var versionedMatch = path.match(/^\/tens\/tt-metal\/(v\d+\.\d+\.\d+)\//);
    if (versionedMatch) {
      return versionedMatch[1];
    }

    // Stable docs URL format: /tens/tt-metal/ttnn/...
    if (/^\/tens\/tt-metal\/ttnn\//.test(path)) {
      return 'v2.10.0';
    }
